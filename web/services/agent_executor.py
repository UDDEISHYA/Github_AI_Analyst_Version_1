...
def execute_agent(
    ...
    system_prompt = (
        ...
        "3. Use generate_chart for visualizations with action-oriented titles.\n"
        "4. Use write_finding for each key insight you discover.\n"
        "5. Be thorough but concise. Focus on actionable findings.\n"
        "6. At the end, provide a summary of what you found.\n"
    )
